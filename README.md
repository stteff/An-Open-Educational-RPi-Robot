...
Any computer capable to run Scratch 1.4 (the version supporting the [Mesh](https://en.scratch-wiki.info/wiki/Mesh) method), connected to the same LAN as Raspberry Pi, could become the robot control center:
  ...
  3. > If **Mesh** is not activated, *Host Mesh* by pressing and mouse clicking: <p><kbd>Ctrl</kbd> + <kbd>Share</kbd> from Scratch menu
...
[![non Software License](https://mirrors.creativecommons.org/presskit/buttons/88x31/png/by-sa.png){:height="50%" width="50%"}](https://creativecommons.org/licenses/by-sa/4.0/)
